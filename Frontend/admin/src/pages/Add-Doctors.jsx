...
function DoctorForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      ...
      const cloudLink = await cloudinaryUpload.post('/image/upload', file, {
        headers: {
      ...
      <section className="p-6">
        <div className="flex items-center justify-between">
          <div className="space-y-2 col-span-full lg:col-span-1">
            <p className="font-medium">Input Doctor</p>
            <p className="text-xs">You can enter doctor informations here.</p>
          </div>
        </div>
        <form
