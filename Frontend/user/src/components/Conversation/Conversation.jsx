...
const Conversation = ({
  ...
  return (
    <div className={`conversation ${index === activeIndex ? "active" : ""}`} 
      ...
      {online && <div className="online-dot"></div>}
        <div className="friend-list">
          <img src={ userData?.profilePicture
            ? process.env.REACT_APP_PUBLIC_FOLDER + userData.profilePicture : userImg } 
            ...
            <div className="message-div">
              ...
              <div className="status-div">
                <span className="status">
                  {currentUser === data?.lastMessage?.senderId && handleStatus(data?.lastMessage?.status)}
                </span>
